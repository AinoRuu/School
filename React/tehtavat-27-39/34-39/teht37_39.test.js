...
describe("Tehtävä 37", () => {  
    ...
    test('Tehtävä 37, testataan lisääminen (1p)', () => {
        testTeht37_a();
    });

    test('Tehtävä 37, testataan TableRow-komponentti (1p)', () => {
      testTeht37_b();
    });
  })
...
describe("Tehtävä 38", () => {  
    ...
    test('Tehtävä 38, testataan Poista nappi (1p)', () => {
      testTeht38();
    });
...
describe("Tehtävä 39", () => {  
    ...
    test('Tehtävä 39, Lisätään opintojakso (1p)', () => {
        testTeht39();
    });
  });
