...
describe("Tehtävä 16e Lomakkeen luominen (1p)", () => {
  test("Tehtävä 16e, Lomake elementti (0.25p)", () => {
    render(<Lomake />);
  ...
  cleanup();
  test("Tehtävä 16e, valmentaja komponentti (0.25p)", () => {
  ...
  cleanup();
  test("Teht 16e Joukkueet taulukko (0.25p)", () => {
  ...
  cleanup();
  test("Tehtävä 16e, Lisää nappi (0.25p)", () => {
...
cleanup();
describe("Tehtävä 16f, Delete toiminto (1p)", () => {
  test("Tehtävä 16f, onDelete props ja nappi (0.25p)", () => {
  ...
  cleanup();
  test("Tehtävä 16f, onDelete props ei ole pakollinen, Taulukko tulostuu silti (0.25p)", () => {
    render(<Joukkueet joukkueet={joukkueetData} />);
  ...
  test("Tehtävä 16f, Poistetaan valittu joukkue ja näytetään päivitetty taulukko (0.5p)", () => {
    render(<Lomake />);
    const joukkueInput = screen.getByTestId("joukkue");
    const kotipaikkaInput = screen.getByTestId("kotipaikka");
    const valmentajaLista = screen.getByTestId("valmentajaSelect");
...
describe("Tehtävä 16g, Change ominaisuus (1p)", () => {
  test("Tehtävä 16g, onChange props ja nappi (0.25p)", () => {
  ...
  test("Tehtävä 16g, onChange props ei ole pakollinen, Taulukko tulostuu silti (0.25p)", () => {
    render(<Joukkueet joukkueet={joukkueetData} />);
  ...
  test("Tehtävä 16g, Tietojen muuttaminen (0.5p)", () => {
